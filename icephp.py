...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="ICEphp - PHP Enumerator")
    parser.add_argument("url", help="Target URL")
    parser.add_argument("--common", action="store_true", help="Use common PHP wordlist")
...
#  | $$  | $$    $$| $$      | $$  | $$| $$  | $$| $$  | $$
# /$$$$$$|  $$$$$$/| $$$$$$$$| $$$$$$$/| $$  | $$| $$$$$$$/
#|______/ \______/ |________/| $$____/ |__/  |__/| $$____/ 
#                            | $$                | $$      
#                            | $$                | $$      
#                            |__/                |__/''' + Style.RESET_ALL + "v1.0")
#    print("We're all mad here...")
    ...
    if args.common:
        payload_list = read_payload('1000commonphp.txt')
    else:
        payload_list = read_payload('php.txt')
